...
tolerance = 1e-8  # Small tolerance ensures accurate steady-state detection
window_size = 100  # Use the last 100 steps to check for steady state
...
plt.title('Velocity Profile vs. Height')
plt.legend()
plt.show()
...
plt.xlabel('Time (s)')
plt.ylabel('Velocity (m/s)')
plt.title('Velocity Evolution at Selected Nodes')
plt.legend()
plt.show()
...
# The system reaches steady state at approximately t = 5491.62 seconds, I feel like this might be too long?
